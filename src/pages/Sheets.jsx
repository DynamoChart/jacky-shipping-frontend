  ...
  return (
    ...
    <Card className="overflow-hidden shadow-none border border-gray-200 mb-2">
        <Card.Content className="p-4">
          ...
          >
            <TagGroup.List className="gap-2 flex-wrap max-h-32 overflow-y-auto">
              <Tag id={null} className="font-medium">
...
<Card className="overflow-hidden mb-2 ">
  <Card.Content className="p-0">
   ...
   {/* Plant Sums Summary Table - Excel Style */}
{/* Plant Sums Summary Table - Excel Style */}
<Card className="overflow-hidden  shadow-none -mb-4">
  <Card.Content className="p-0">
    <div className="p-2">
...
<div className="p-2">
  <Table aria-label="Plant summary table" variant="secondary">
    <Table.ScrollContainer className="max-h-[400px]">
     ...
     {/* Detailed Shipments Table - Grouped by Plant */}
{/* Detailed Shipments Table - Grouped by Plant */}
